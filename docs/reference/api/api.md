...
See [Avoid Message Conflict](/docs/guides/help#avoid-message-conflict) for information
...
(for example, for some log rotation scenarios), see [Reopening log files](/docs/guides/help/docs/guides/help#reopening).

* See [`destination` parameter](/docs/reference/api#destination)
* See [`sonic-boom` ⇗](https://github.com/mcollina/sonic-boom)
* See [Reopening log files](/docs/guides/help/docs/guides/help#reopening)
* See [Asynchronous Logging ⇗](/docs/asynchronous)
