...
For full documentation of command line switches see the [pino-sentry README](https://github.com/aandrewww/pino-sentry/blob/master/README).
...
See [https://www.elastic.co/guide/en/kibana/current/setup.html](https://www.elastic.co/guide/en/kibana/current/setup.html) to learn
how to setup [Kibana][kibana].

For Docker users, see
[[https://github.com/deviantony/docker-elk](https://github.com/deviantony/docker-elk)]([https://github.com/deviantony/docker-elk](https://github.com/deviantony/docker-elk)) to setup an ELK stack.
