...
* See [`pino.destination`](/docs/guides/api/docs/api#pino-destination)
...
* [`pino.destination` API](/docs/guides/api/docs/api#pino-destination)
* [`destination` parameter](/docs/guides/api/docs/api#destination)
